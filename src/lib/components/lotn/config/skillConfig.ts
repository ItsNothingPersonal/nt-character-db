...
export type SkillConfig = {
	physical: Record<PhysicalSkill, { helptext: string; hasSpecializations: boolean }>;
	social: Record<SocialSkill, { helptext: string; hasSpecializations: boolean }>;
	mental: Record<MentalSkill, { helptext: string; hasSpecializations: boolean }>;
};
