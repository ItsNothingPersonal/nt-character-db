...
export const flawConfig: FlawsConfigSchema = {
	...
	Farmer: {
		...
		prerequisite: { name: 'Blood Potency', value: 2 },
		category: 'Feeding'
	},
	"Methuselah's Thirst": {
