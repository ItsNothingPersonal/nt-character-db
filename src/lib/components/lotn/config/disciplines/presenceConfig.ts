	...
	powers: {
		...
		'Eyes of the Serpent': {
			...
			challengePool: {
				...
				defender: { attribute: 'Wits', skillOrAttribute: 'Composure' }
			},
			system:
		...
		'Silencing Tongue': {
			...
			cost: 'One Rouse check',
			challengePool: {
				attacker: { attribute: 'Charisma', skill: 'Leadership' },
		...
		Entrancement: {
			...
			cost: 'One Rouse check',
			challengePool: {
				attacker: { attribute: 'Manipulation', skill: 'Leadership' },
		...
		Summon: {
			...
			challengePool: {
				attacker: { attribute: 'Manipulation', skill: 'Leadership' },
				defender: { attribute: 'Composure', skillOrAttribute: 'Intelligence' }
			},
			system:
